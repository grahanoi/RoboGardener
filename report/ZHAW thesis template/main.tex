...
\thesistitle{Digital Twin for Autonomous Robots using ROS}             % Thesis title,              command: \ttitle
\thesistype{Projectwork 2}             % Type of thesis (e.g. Master Thesis) \ttype
...
\degree{Bachelor Applied Digital Life Sciences}          % Degree name,                        \degreename
\studyprogram{Applied Digital Life Sciences} 
